 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetConcerts($filter: concertsFilter!) {\n  concertsCollection(filter: $filter) {\n    edges {\n      node {\n        id\n        title\n        description\n        date\n        on_sale\n        genres {\n          name\n        }\n        places {\n          name\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query GetConcerts($filter: concertsFilter!) {\n  concertsCollection(filter: $filter) {\n    edges {\n      node {\n        id\n        title\n        description\n        date\n        on_sale\n        genres {\n          name\n        }\n        places {\n          name\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetPlaces {\n  placesCollection {\n    edges {\n      node {\n        id\n        name\n      }\n    }\n  }\n}"): (typeof documents)["query GetPlaces {\n  placesCollection {\n    edges {\n      node {\n        id\n        name\n      }\n    }\n  }\n}"];
